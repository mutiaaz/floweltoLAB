...
class GuestsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Guest/GuestsHome',compact('categories'));
    }
    ...
    public function categoriesCheck( $id )
    {
        ...
        $cid = $id;
        return view('Guest/GuestsVFlower',compact('categories_flower','categories'));
    }
    ...
    public function detailPage($id)
    {
        ...
        return view('Guest/FlowerDetail',compact('flower'));
    }
