...
<body style="background-color: linen">
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fd3a69">
        <a class="navbar-brand" href="{{url('/userhome')}}">Flowelto Shop</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            @foreach($liCats as $liCat)
                                <a class="dropdown-item" href="{{url('/userVF',$liCat->id)}}">{{$liCat->category_name}}</a>
                            @endforeach
                        </div>
                    </li>
                    <li class="nav-item dropdown">
            ...
            <div class="row" style="text-align: center; padding: 20px">
                @foreach($categories as $category)
                    <div class="col" style="margin: 20px">
                        <a  href="{{url('/userVF',$category->id)}}" style="color: black">
