...
<div class="container" style="padding: 20px;background-color: white;display: flex">
    ...
    <div class="row">
        <div class="col" style="text-align: center">
            <img src="{{asset('assets/'.$category->category_img)}}" style="height: 350px;width: auto; margin-right: 20px">
        </div>
        <div class="col-sm">
            <form method="post" action="{{url('/saveUpdateCategory')}}/{{$category->id}}">
                @csrf
                <div class="form-group row">
                    <label for="CategoryName" class="col-sm col-form-label">Category Name</label>
                    <div class="col-sm">
                ...
                <div class="form-group row">
                    <label for="CategoryImg" class="col-sm col-form-label">Category Image</label>
                    <input type="hidden" name="old_image" value="{{$category->category_img}}">
                    <div class="col-sm">
                        <input type="file" class="form-control" style="border: none" name="category_img">
                    </div>
                </div>
                <div class="form-group row">
